...
export default function Guarantee() {
	return (
		<div className="mx-auto max-w-4xl px-4 py-16 leading-relaxed">
			<h1 className="mb-6 text-3xl font-bold text-secondary-900 md:text-4xl">Гарантии</h1>
			...
			<p className="mb-4 md:text-xl xl:text-2xl">В реальных условиях магазин мог бы гарантировать:</p>
			<ul className="mb-4 list-disc pl-6 italic md:text-xl xl:text-2xl">
